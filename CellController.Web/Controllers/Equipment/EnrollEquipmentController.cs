...
{
    public class EnrollEquipmentController : Controller
    {
        ...
        //function for validating if the equipment exist in the table (for update)
        [HttpGet]
        public JsonResult ValidateEntryForUpdateWithHost(string username, string equipment, int ID, string host)
        {
            int count = 0;

            //get the result
            count = UserEquipmentModels.CheckEntryForUpdateWithHost(username, equipment, ID, host);

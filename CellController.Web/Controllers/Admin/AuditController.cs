...
namespace CellController.Web.Controllers.Admin
{
    public class AuditController : Controller
    {
        ...
        //function for getting audit logs to be displayed on the gridview
        [HttpGet]
        public JsonResult GetLogs()
        {
            ...
            //get columns
            Dictionary<string, string> columns = AuditModel.GetCols();
            ...
            {
                //get total row count
                int totalRows = AuditModel.GetCount(where, ((Request["searchStr"] == null) ? "" : Request["searchStr"].ToString()));
            ...
            else
            {
                ...
                {
                    transactions = AuditModel.GetData(0, 0, where, sorting, ((Request["searchStr"] == null) ? "" : Request["searchStr"].ToString()));
                }
                else
                {
                    transactions = AuditModel.GetData(start, pagesize, where, sorting, ((Request["searchStr"] == null) ? "" : Request["searchStr"].ToString()));
                }
                ...
                Dictionary<string, object> cols_arr = custom_helper.PrepareStaticColumns(cols);
                result_config.Add("column_config", custom_helper.PrepareColumns(cols_arr));
                result_config.Add("TotalRows", AuditModel.GetCount(where, ((Request["searchStr"] == null) ? "" : Request["searchStr"].ToString())));
            }
